...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Edit Team Category</li>
    </ol>
  </section>
    ...
    <div class="row">
      ...
      <div class="col-xm-12 col-sm-12 col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ url('/admin/team_category/update/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="alert alert-success alert-dismissible">
                ...
                Team Category has been updated successfully.
              </div>
              @endif
