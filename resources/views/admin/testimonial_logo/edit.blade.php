    ...
    <div class="row">
      ...
      <div class="col-xm-12 col-sm-12 col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ url('/admin/testimonial_logo/update/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="clearfix">
                    <?php if($list->image && File::exists(public_path('uploads/'.$list->image)) ) { ?>
                      <img src="{{ asset('/uploads/'.$list->image) }}" style="margin: 10px 0 0 0;max-width: 200px;"> <a href="{{url('/admin/testimonial_logo/file-destroy/'.$list->id)}}"><i class="fa fa-fw fa-close"></i></a>
                    <?php } ?>
                  </div>
