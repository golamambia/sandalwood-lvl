...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Service Category <a href="{{ url('/admin/service_category/add') }}" class="btn btn-primary">Add</a>
    </h1>
    <ol class="breadcrumb">
        ...
        <table id="example2" class="table table-bordered table-hover dataTable">
          ...
          @if ($lists->count() > 0)
           ...
           <tr>
            ...
            <td>
              <a href="{{ url('/admin/service_category/edit/'.$list->id) }}" title="Edit"><i class="fa fa-fw fa-edit"></i></a>
              <a href="{{ url('/admin/service_category/status/'.$list->id.'/'.$list->status) }}" title="Status"><i class="fa fa-fw fa-lightbulb-o {{$list->status!=1?'inactive':''}}"></i></a>
              <a href="{{ url('/admin/service_category/delete/'.$list->id) }}" onclick="return confirm('Are you sure?');" title="Delete"><i class="fa fa-fw fa-close"></i></a>
            </td>
