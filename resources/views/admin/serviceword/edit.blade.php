            ...
            <div class="box-body">
              ...
              <!-- <div class="form-group clearfix image2">
                ...
                <div class="col-sm-10">
                  ...
                  <div class="clearfix">
                    ...
                    if($page[0]->image2 && File::exists(public_path('uploads/'.$page[0]->image2)) )
                      {
                        ?>
                        <img src="{{ asset('/uploads/'.$page[0]->image2) }}" style="margin: 10px 0 0 0;max-width: 300px;">
                        <?php
                      }
                      ?>
                  </div>
                ...
                @foreach($page_extra as $val)
                  ...
                  @endif
                  @if($val->section_type==9 || $val->section_type==10 || $val->section_type==11 || $val->section_type==12 || $val->section_type==16 || $val->section_type==17 || $val->section_type==18 || $val->section_type==19)
                    <div class="form-group clearfix">
                  ...
                  @endif
                  @if($val->section_type=="1" || $val->section_type==4 || $val->section_type==13 || $val->section_type==14 || $val->section_type==15 || $val->section_type==16 || $val->section_type==17 || $val->section_type==18 || $val->section_type==19)
                    <div class="form-group clearfix">
                  ...
                  @endif 
                  @if($val->section_type==1 || $val->section_type==5 || $val->section_type==6 || $val->section_type==7 || $val->section_type==10 || $val->section_type==12 || $val->section_type==15 || $val->section_type==17 || $val->section_type==19)
                    <div class="form-group clearfix">
