...
if(old('rank')>0)
{
  ...
  $header_menu = get_fields_value_where('gs_team',"id>0",'rank','desc');
    ...
    <div class="row">
      ...
      <div class="col-xm-12 col-sm-12 col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ url('/admin/team/add/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="designation" id="designation" placeholder="Enter ..." value="{{ Request::old('designation') }}">
                </div>
              </div>
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="rank" id="rank" data-validation-engine="validate[custom[number]]" placeholder="Enter ..." value="{{ $rank }}">
                </div>
              </div>
