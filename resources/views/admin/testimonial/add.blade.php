    ...
    <div class="row">
      ...
      <div class="col-xm-12 col-sm-12 col-md-12">
        ...
        <div class="box box-primary">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" action="{{ url('/admin/testimonial/add/') }}"  method="post" enctype="multipart/form-data" class="formvalidation">
            ...
            <div class="box-body">
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="rank" id="rank" data-validation-engine="validate[custom[number]]" placeholder="Enter ..." value="{{ Request::old('rank') }}">
                </div>
              </div>
              <div class="form-group clearfix">
