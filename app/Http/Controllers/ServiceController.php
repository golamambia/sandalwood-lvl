...
class ServiceController extends Controller
{
	...
	public function index()
	{
		...
		if($search)
		{
			$search_column_array = array('services.id' => 'Id', 'services.name' => 'Name', 'services.designation' => 'Designation', 'service_category.name' => 'Category', 'services.rank' => 'Rank', 'services.status' => 'Status', 'services.created_at' => 'Created At');
		...
		$lists = Service::select('services.*','service_category.name as cat_name')
		->leftjoin('service_category', 'services.category_id', '=', 'service_category.id')
		->whereRaw($where)
		...
		return view('admin.service.index', compact('lists','column_array','sorting_array','search'));
	}

	public function add()
	{
		$category_list = Service_category::orderBy('rank', 'asc')->get();
		return view('admin.service.add', compact('category_list'));
	}
	...
	public function insert(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/service/add')->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
	...
	public function edit($id)
	{
		...
		$category_list = Service_category::orderBy('rank', 'asc')->get();
		return view('admin.service.edit', compact('list','category_list'));
	}
	...
	public function update(Request $request)
	{
		...
		if ($validator->fails())
		{
			return Redirect::to('admin/service/edit/'.$id)->withErrors($validator)->withInput(); 
		}
		else
		{
			try {
